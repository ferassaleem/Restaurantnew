...
namespace Restaurant.Manager
{
    public partial class MAdmin : Form
    {
        ...
        {
            CahngeAdmin cahngeAdmin = new CahngeAdmin();
            cahngeAdmin.TopLevel = false;
            cahngeAdmin.Dock = DockStyle.Fill;
            this.panel2.Controls.Clear();
            this.panel2.Controls.Add(cahngeAdmin);
            cahngeAdmin.Show();
        }
        public void LoadData()
        {
            ...
            conn.Open();
            string query = "SELECT name,username,password,phone,address,email FROM Admin";
        ...
        private void MAdmin_Load(object sender, EventArgs e)
        {
            LoadData();
        }
    }

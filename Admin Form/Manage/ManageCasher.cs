...
{
    public partial class ManageCasher : Form
    {
        ...
        {
            AddCasher addCasher = new AddCasher();
            addCasher.TopLevel = false;
            addCasher.Dock = DockStyle.Fill;
            this.panel2.Controls.Clear();
            this.panel2.Controls.Add(addCasher);
            addCasher.Show();
        }

        private void btnUpdate_Click(object sender, EventArgs e)
        {
            UpdateCasher updateCasher = new UpdateCasher();
            updateCasher.TopLevel = false;
            updateCasher.Dock = DockStyle.Fill;
            this.panel2.Controls.Clear();
            this.panel2.Controls.Add(updateCasher);
            updateCasher.Show();
        }

        private void btnDelete_Click(object sender, EventArgs e)
        {
            DeleteCasher deleteCasher = new DeleteCasher();
            deleteCasher.TopLevel = false;
            deleteCasher.Dock = DockStyle.Fill;
            this.panel2.Controls.Clear();
            this.panel2.Controls.Add(deleteCasher);
            deleteCasher.Show();
        }
        ...
        public void LoadData()
        {
            ...
            conn.Open();
            string query = "SELECT Name,UserName,Password,Phone,Address FROM Casher";
        ...
        private void ManageCasher_Load(object sender, EventArgs e)
        {
            LoadData();
        }
    }
